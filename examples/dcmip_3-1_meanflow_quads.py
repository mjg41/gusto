...
domain = SphericalDomain(mesh=mesh, is_rotating=False)
...
output = OutputParameters(Verbose=True, dumpfreq=100000, dirname='meanflow_ref',
...
# build time stepper
stepper = CrankNicolson(state, advection_dict, linear_solver,
                        compressible_forcing)

stepper.run(t=0, tmax=100.0) #tmax was 3600.

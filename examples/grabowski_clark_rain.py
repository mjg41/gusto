...
output = OutputParameters(dirname='grabowski_clark_rain_eddy_mixing_physics_heatflux', dumpfreq=10, dumplist=['u', 'rho', 'theta'], perturbation_fields=['rho', 'theta', 'water_v'], log_level='INFO')
